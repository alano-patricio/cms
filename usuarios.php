                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <select id="nivelUsuario" name="nivelUsuario" class="form-control">
                                        <?php if (@$listarUsuarioParaEditar['nivel'] == 1) { ?>
                                            <option selected value="1">Administrador</option>
                                            <option value="2">Supervisor</option>
                                            <option value="3">Estagiário</option>
                                        <?php } elseif (@$listarUsuarioParaEditar['nivel'] == 2) { ?>
                                            <option value="1">Administrador</option>
                                            <option selected value="2">Supervisor</option>
                                            <option value="3">Estagiário</option>
                                        <?php } elseif (@$listarUsuarioParaEditar['nivel'] == 3) { ?>
                                            <option value="1">Administrador</option>
                                            <option value="2">Supervisor</option>
                                            <option selected value="3">Estagiário</option>
                                        <?php } else { ?>
                                ...
                                <tbody> 
                                    <?php foreach ($recebeDadosUsuarios as $users): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form name = "formExcluir<?php echo $users->id; ?>"action="action/delete.php" method="POST">
                                                    <input type="hidden" name="excluirUsuario" value="<?php echo $users->id; ?>">
